#    Powershell Obfuscation - Void (Whitespace)
...
#
#    Usage example: .\NV-Void.ps1 -nvi ".\Before.ps1" -nvo ".\Minfied.ps1"
...
$Host.UI.RawUI.WindowTitle="PowerShell Void Obfuscation"
clear
function log{
...
function main{
    ...
    $binary = ([System.Text.Encoding]::UTF8.GetBytes($content) | ForEach-Object {[convert]::ToString($_, 2).PadLeft(8, '0')}) -join ''
